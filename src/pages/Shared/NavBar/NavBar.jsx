...
<Link className="px-4 py-2 block hover:bg-gray-100" to="/dashboard">Dashboard</Link>
...
<Link className="px-1 py-2 hover:text-blue-500" to="/dashboard">Dashboard</Link>
<button className="text-left px-1 py-2 hover:text-blue-500">Logout</button>
</div>
)}
</nav>
);
